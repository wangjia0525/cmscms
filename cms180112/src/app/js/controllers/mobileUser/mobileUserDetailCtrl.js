App
    .controller('mobileUserDetailCtrl', function ($scope, $rootScope, $http, $stateParams, Notify, OtherFactory, ModalService, $cookieStore, MobileUserFactory, FieldFactory, $location, $timeout, mdFactory) {
       ...
       /* $scope.JobPosition = function () {
        ...
        $scope.getMobileUserDetail = function (_epmtInfoList_) {
            ...
            //    }
            //}
            $scope.mobileUserDetail=_epmtInfoList_;
        };
        /* 找到指定id的父级对象 */
