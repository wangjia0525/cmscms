...
App
    .controller('reallyDeleteTopicCtrl', function($scope,$http,$cookieStore,TopicFactory,Notify,ModalService,MobileUserFactory,$timeout,FieldFactory,mdFactory) {
        ...
        $scope.TopicListCallback = function(data){
            ...
            $cookieStore.put('myapp.deleteTopiccookie.searches',$scope.getParams());
        };
        ...
        $scope.getCookie = function () {
            if ($cookieStore.get('myapp.deleteTopiccookie.searches')) {
                $scope.turnPage.currentPage = $cookieStore.get('myapp.deleteTopiccookie.searches').page;
                $scope.fieldSelectValue = $scope.realmList[$cookieStore.get('myapp.deleteTopiccookie.searches').fieldTypes];
                $scope.sortSelectValue = $scope.sortTypes[$cookieStore.get('myapp.deleteTopiccookie.searches').sortTypes];
                $scope.searchKey = $cookieStore.get('myapp.deleteTopiccookie.searches').searchKey;
            } else{
                $scope.searchKey = "";
