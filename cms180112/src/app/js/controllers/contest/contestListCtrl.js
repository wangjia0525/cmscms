...
App
    .controller('contestListCtrl', function($scope,$http,$cookieStore,ContestFactory,MobileUserFactory,Notify,$timeout,ModalService,FieldFactory,mdFactory) {
        ...
        $scope.getContestListCallback= function(data){
            ...
            $cookieStore.put('myapp.contestListcookie.searches',$scope.getParams());
        };
        ...
        $scope.getCookie = function () {
            if ($cookieStore.get('myapp.contestListcookie.searches')) {
                $scope.turnPage.currentPage = $cookieStore.get('myapp.contestListcookie.searches').page;
                $scope.fieldSelectValue = $scope.realmList[$cookieStore.get('myapp.contestListcookie.searches').fieldTypes];
                $scope.sortSelectValue = $scope.sortTypes[$cookieStore.get('myapp.contestListcookie.searches').sortTypes];
                $scope.searchKey = $cookieStore.get('myapp.contestListcookie.searches').searchKey;
            } else{
                $scope.searchKey = "";
