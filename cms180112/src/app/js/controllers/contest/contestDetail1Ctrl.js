App
    .controller('contestDetail1Ctrl', function($scope,$rootScope,$http,$stateParams,ModalService,Notify,$timeout,$location,FieldFactory,$cookieStore,MobileUserFactory,ContestFactory,mdFactory) {
