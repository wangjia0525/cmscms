	...
	$.extend(F, {
		...
		defaults: {
			...
			tpl: {
				...
				error: '<p class="fancybox-error">所请求的图片不存在或服务器错误.<br/>请稍后重试.</p>',
		...
		rot: function(f_w, f_h, translate) {
			if (F.rad / 90 % 2) {
				$("#fancybox-img").css("-webkit-transform", "translate(" + (translate - 4) + "px," + (-translate) + "px)" + " rotate(" + F.rad + "deg)").css("-moz-transform", "translate(" + (translate - 4) + "px," + (-translate) + "px)" + " rotate(" + F.rad + "deg)").css("-o-transform", "translate(" + (translate - 4) + "px," + (-translate) + "px)" + " rotate(" + F.rad + "deg)").css("-ms-transform", "translate(" + (translate - 4) + "px," + (-translate) + "px)" + " rotate(" + F.rad + "deg)").css("transform", "translate(" + (translate - 4) + "px," + (-translate) + "px)" + " rotate(" + F.rad + "deg)");
				...
				$("#fancybox-img").css("-webkit-transform", "rotate(" + F.rad + "deg)").css("-moz-transform", "rotate(" + F.rad + "deg)").css("-o-transform", "rotate(" + F.rad + "deg)").css("-ms-transform", "rotate(" + F.rad + "deg)").css("transform", "translate(-4px, 0px) rotate(" + F.rad + "deg)");
