        ...
        .directive( 'treecontrol', ['$compile', function( $compile ) {
            ...
            return {
                ...
                controller: ['$scope', '$templateCache', '$interpolate', 'treeConfig', function( $scope, $templateCache, $interpolate, treeConfig ) {
                    ...
                    /* 自己加的一个联通$scope的方法 */
                    $scope.selectChangeChild = function(_status_,_obj_){
                    		
												$scope.$emit('selectChange',{
													status:_status_,
													obj	:_obj_
                    ...
                    if(!template) {
                        template =
                            ...
                            '<label class="checkbox-inline c-checkbox">'+
                     				'<input type="checkbox"  ng-model="node.selectStatus" ng-change="selectChangeChild(node.selectStatus,node)" />'+
                    			 	'<span class="fa fa-check fa-1"></span></label>'+
